			...
			<div class="foodrecipe-content-meta row">
				<div class="col-sm-5">
					...
					if ( $wp_query->post_count == 1 ) {
					    echo "<h2 class='count-post'>" . $wp_query->found_posts . " post found"; 
                    } else { 
                    	echo "<h2 class='count-post'>" . $wp_query->found_posts . " posts found";
                    } ?>
				</div>
			...
			<?php while ( have_posts() ) {
				...
				<div <?php post_class(); ?>>
					...
					<div class="foodrecipe-post-categories">
		                <?php the_category("<span>&nbsp;</span>/<span>&nbsp</span>"); ?>
		            </div>
